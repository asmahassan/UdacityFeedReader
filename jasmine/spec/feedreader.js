    ...
    describe('RSS Feeds', function() {
         ...
         */
         function testUrl(input,feedNo){
             it('Feed ' + feedNo + ' has a URL defined and not empty', function(){
         ...
         */
         function testName(input,feedNo){
             it('Feed ' + feedNo + ' has a name defined and not empty', function(){
               expect(input).toBeDefined();
               expect(input.length).not.toBe(0);
             });            
         }
    ...
    describe('The menu', function() {
         ...
         */
         ...
         it('Menu visibility changes when menu icon is clicked', function(){
            //Click the menu Icon to trigger Meny display
            $(".menu-icon-link").click();
            expect($('body').hasClass("menu-hidden")).toBe(false);

            //Click the menu Icon to trigger Meny hide
            $(".menu-icon-link").click();
            expect($('body').hasClass("menu-hidden")).toBe(true);
         });
    });
